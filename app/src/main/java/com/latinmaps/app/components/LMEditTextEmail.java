 ...
 */
public class LMEditTextEmail extends EditText{
    ...
    public LMEditTextEmail(Context context) {
        super(context);
        init(context);
    }

    public LMEditTextEmail(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        // this Contructure required when you are using this view in xml
    }

    public LMEditTextEmail(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LMEditTextEmail(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(final Context context){
        ...
        addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > 0) {
                    setCompoundDrawablesWithIntrinsicBounds(ContextCompat.getDrawable(context, R.drawable.login_user),null, null, null);
                } else {
